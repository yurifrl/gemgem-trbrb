...
class ThingPolicyTest < MiniTest::Spec
  ...
  let (:policy) { Thing::Update.policy_class.first.new(user, thing) }
  ...
  describe "signed in" do
    ...
    # is author
    it do
      policy = Thing::Update.policy_class.first.new(author, thing)
      policy.update?.must_equal true
    end

    # not author
    it do
      policy = Thing::Update.policy_class.first.new(user, thing)
  ...
  describe "admin" do
    ...
    it do
      ...
      policy = Thing::Update.policy_class.first.new(admin, thing)
